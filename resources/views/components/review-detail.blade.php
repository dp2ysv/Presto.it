        ...
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-center align-items-center">
                <div class="col-12 col-lg-8 d-flex flex-column align-items-center text-center bg-white"
                            ...
                            <div class="carousel-inner">
                                @foreach ($article->images as $key => $image)
                                    <div class="carousel-item @if($loop->first) active @endif">
                                        ...
                                        <div class="bg-white py-3 text13">
                                            <strong>Tag per questa immagine:</strong>
                                            @if (!empty($image->labels))
                                                @foreach ($image->labels as $label)
                                                    #{{ $label }},
                                                @endforeach
                                            @else
                                                <div class="textRed">Non ci sono tag per questa immagine.</div>
                                            @endif
                                        </div>
                                        <div
                                            class="bg-white pb-3 d-flex flex-wrap justify-content-around align-items-center text13">
                                            <div class="col-12 mb-2">
                                                <strong>Valutazioni:</strong>
                                            </div>
                                            <div class="col-4 col-md-1 d-flex flex-column flex-md-row align-items-center">
                                                <div class="text-center me-2 {{ $image->adult }}"></div>Contenuti per adulti
                                            </div>
                                            <div class="col-4 col-md-1 d-flex flex-column flex-md-row align-items-center">
                                                <div class="text-center me-2 {{ $image->violence }}"></div>Contenuti violenti
                                            </div>
                                            <div class="col-4 col-md-1 d-flex flex-column flex-md-row align-items-center">
                                                <div class="text-center me-2 {{ $image->violence }}"></div>Contenuti violenti
                                            </div>
                                            <div class="col-4 col-md-1 d-flex flex-column flex-md-row align-items-center">
                                                <div class="text-center me-2 {{ $image->spoof }}"></div>Contenuti ingannevoli
                                            </div>
                                            <div class="col-4 col-md-1 d-flex flex-column flex-md-row align-items-center">
                                                <div class="text-center me-2 {{ $image->racy }}"></div>Contenuti inadeguati
                                            </div>
                                            <div class="col-4 col-md-1 d-flex flex-column flex-md-row align-items-center">
                                                <div class="text-center me-2 {{ $image->adult }}"></div>Contenuti sensibili
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="container-fluid mb-3 reviewDetails">
